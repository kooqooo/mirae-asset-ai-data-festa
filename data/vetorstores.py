...
documents = [Document(page_content=document["question"], metadata={"ids": idx, "category": document["category"], "answer": document["answer"]}) for idx, document in enumerate(faq)]
...
if __name__ == "__main__":
    ...
    chroma_similarity_search_with_relevance_scores = chroma.similarity_search_with_relevance_scores(query)
    end = time()
    ...
    faiss_similarity_search_with_relevance_scores = faiss.similarity_search_with_relevance_scores(query)
    end = time()
